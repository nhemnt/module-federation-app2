...
eval("var moduleMap = {\n\t\"./Widget\": () => {\n\t\treturn Promise.all([__webpack_require__.e(\"vendors-node_modules_namor_dist_index_js-node_modules_react-table_index_js-node_modules_style-611b8a\"), __webpack_require__.e(\"webpack_sharing_consume_default_react_react-webpack_sharing_consume_default_react_react-webpa-dbb91f\"), __webpack_require__.e(\"src_Widget_js\")]).then(() => () => (__webpack_require__(/*! ./src/Widget */ \"./src/Widget.js\")));\n\t}\n};\nvar get = (module, getScope) => {\n\t__webpack_require__.R = getScope;\n\tgetScope = (\n\t\t__webpack_require__.o(moduleMap, module)\n\t\t\t? moduleMap[module]()\n\t\t\t: Promise.resolve().then(() => {\n\t\t\t\tthrow new Error('Module \"' + module + '\" does not exist in container.');\n\t\t\t})\n\t);\n\t__webpack_require__.R = undefined;\n\treturn getScope;\n};\nvar init = (shareScope, initScope) => {\n\tif (!__webpack_require__.S) return;\n\tvar oldScope = __webpack_require__.S[\"default\"];\n\tvar name = \"default\"\n\tif(oldScope && oldScope !== shareScope) throw new Error(\"Container initialization failed as it has already been initialized with a different share scope\");\n\t__webpack_require__.S[name] = shareScope;\n\treturn __webpack_require__.I(name, initScope);\n};\n\n// This exports getters to disallow modifications\n__webpack_require__.d(exports, {\n\tget: () => get,\n\tinit: () => init\n});\n\n//# sourceURL=webpack://@dynamic-system-host/app2/container_entry?");
